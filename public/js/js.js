document.addEventListener('DOMContentLoaded',()=>{
    ...
    <div class="Ai_modal">
        ...
        <form id="Ai_form" class="display_none">
            ...
            <a target="_blank" href="https://akuprof.ru/terms.html">Отправляя свои данные, вы соглашаетесь с пользовательским соглашением!</a>
        </form>
    </div>
    ...
    <div class="Ai_modal_instructions display_none">
        <div class="instructions_container">
            ...
            <div class="instructions_block assist_Ai_instruc" id="instructions_Ai">
                ...
                <p> * Обратите внимание: данный ИИ-ассистент хранит в памяти только 4 последних сообщения (включая собственные ответы). Если ваш запрос ссылается на более ранние этапы диалога, система не сможет предоставить корректный ответ.</p>
                </div>
