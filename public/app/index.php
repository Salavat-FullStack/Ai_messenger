...
// Всё, теперь переменная $context готова и в ней лежат полные данные!
    ...
    $systemPrompt = "
        ...
        - Если из 10 товаров ни один не подходит по смыслу: вежливо ответь, что не можешь найти точное решение в каталоге, и предложи обратиться к менеджеру по тел.: {$companyNumber}.
