...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $prompt = "
        ...
        5. Если пользователь спрашивает: где можно купить товар, где есть доставка, если самовызов, какой ваш график работы, до скольки работаете, адрес-местоположение,
