...
// Всё, теперь переменная $context готова и в ней лежат полные данные!
    ...
    $systemPrompt = "
        Ты — квалифицированный ИИ-консультант интернет-магазина звукоизоляционных материалов. Твоя задача — подбирать материалы и отвечать на вопросы, строго опираясь на предоставленный контекст (10 товаров из базы данных).
