...
//     // $question = trim("Нужен акустические панели 'Пирамиды'. Основание - 10 мм, высота Пирамиды - 30 мм. Общая площадь - 12,5 кв. М. Доставка в Сочи. Чем можете помочь?");
//     // $question = trim("Добрый день, по звукоизоляции в квартире от шума соседей обследования, проекты делаете?");
//     // $question = trim("Здравствуйте. Я интересуюсь звукоизоляции без каркасным. Рассматриваю изорвал. Чего можете посоветовать, толщина максимум 3 см.");
//     // $question = trim("Нужен акустические панели Пирамиды . Основание - 10 мм, высота Пирамиды - 30 мм. Общая площадь - 12,5 кв. М. Доставка в Сочи. Чем можете помочь?");


//     // $question = trim("Добрый день! Интересует данная сетка. Защитная фасадная сетка 55 гр/м² 3х50м (150 м²) зеленая затеняющая");

//     $question = trim("Хотел проконсультироваться по шумоизоляции - две стенки размерами примерно 3х3 метра, обе будут расположены за шкафам");
...
//         1. Если пользователь только здоровается (например: здравствуйте, добрый день и т.д.), 
//         то ответь приветствием и вежливо уточни, что он хотел бы узнать.
//         НЕ добавляй информацию про наличие товара.
