...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $systemPrompt = "        
        ...
        Если контекст подходит только частично: 
            ...
            - и добавь в свой ответ (точную информацию, можно уточните у менеджера по тел.: +7 (495) 970-82-03 или другим доступным способом.) 
        ...
        4. Если товар есть в контексте, ты ОБЯЗАН:
            - кратко описать его
