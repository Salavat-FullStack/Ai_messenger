...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $prompt = "
        ...
        Если контекст не подходит: 
            - честно скажи, что подходящий товар или информация не найдены 
            - не выдумывай характеристики, свойства или наличие товара 
            - также добавть в конце этот текст: К сожалению, ИИ-ассистент не может ответить на ваш вопрос. Пожалуйста, обратитесь к менеджерам по номеру +7 (495) 970-82-03.
        ...
        5. Если пользователь спрашивает: где можно купить товар, где есть доставка, если самовызов, какой ваш график работы, адрес-местоположение,
            то твой ответ должен шаблонным то есть то просто должен ответить так:
