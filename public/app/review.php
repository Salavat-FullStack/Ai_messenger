...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $prompt = '
        ...
        Ты не ограничен в размере переписанного вопроса, если нужно то переделай вопрос максимально понятливо чтобы другойй асистент(ИИ) мог на него ответить, можешь даже вставлять в итоговый вопрос часть диалога. 
