...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $prompt = '
        ...
        Твоя задача — проанализировать историю диалога и понять, что текущий вопрос относиться к прошлым ответам или же это отдельный самостоятельный вопрос, который независит от прошлого диалога, и переписать последний вопрос пользователя так,
        чтобы он был полностью понятен без истории диалога.

        Ты не ограничен в размере переписанного вопроса, если требуеться, то переделай вопрос максимально понятливо чтобы другой асистент(ИИ) мог на него ответить, можешь даже вставлять в итоговый вопрос часть диалога. 
        ...
        4. Ничего не объясняй и не давай ответа на вопрос!
